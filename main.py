...
# Додавання ребер (Маршрути) без ваги
edges = [
...
print("\n[Аналіз різниці]")
print("DFS часто знаходить довший, звивистий шлях, бо йде 'до упору' в одну сторону.")
...
# ==========================================
print("\n>>> ЗАВДАННЯ 3: Алгоритм Дейкстри (зважений граф)")
